...
function AccountPage(props) {
    ...
    useEffect(function () {
        axios({
            method: "get",
            url: `http://localhost:5050/api/v1/users/${userID}/profile`,
                ...
                <Container>
                    {
                        (user) ? (
                            <div className="py-4">
                                <Panel
                                    bordered={true}
                                    className="py-5 p-xs-2 p-sm-2 p-lg-5 shadow-sm"
                                    style={{
                                ...
                                <Panel bordered={false}
                                    ...
                                    <Button color="orange" block={true} size="sm">
                                        <Link to="/deactivate-account" className="text-white">De-activate Account</Link>
                                    </Button>
